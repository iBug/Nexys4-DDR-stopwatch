...
#
# Generated by export_simulation on Fri Nov 16 19:32:01 CST 2018
#
################################################################################
...
'-reset_run' switch to the './ip_counter_6.sh' script.

./ip_counter_6.sh -reset_run
...
./ip_counter_6.sh -noclean_files

For more information on the script, please type './ip_counter_6.sh -help'.
