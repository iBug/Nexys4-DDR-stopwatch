...
#
# Generated by export_simulation on Fri Nov 16 19:30:32 CST 2018
#
################################################################################
...
'-reset_run' switch to the './ip_counter_10.sh' script.

./ip_counter_10.sh -reset_run
...
./ip_counter_10.sh -noclean_files

For more information on the script, please type './ip_counter_10.sh -help'.
