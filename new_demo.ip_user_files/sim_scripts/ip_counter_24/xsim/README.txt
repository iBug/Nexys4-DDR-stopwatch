...
#
# Generated by export_simulation on Sat Nov 17 21:19:17 CST 2018
#
################################################################################
...
'-reset_run' switch to the './ip_counter_24.sh' script.

./ip_counter_24.sh -reset_run
...
./ip_counter_24.sh -noclean_files

For more information on the script, please type './ip_counter_24.sh -help'.
