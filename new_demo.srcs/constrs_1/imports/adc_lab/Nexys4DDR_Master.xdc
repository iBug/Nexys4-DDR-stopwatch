...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets { Hold }];
...
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { All_Up }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]
set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { SelectFast }]; #IO_L13N_T2_MRCC_14 Sch=sw[3]
