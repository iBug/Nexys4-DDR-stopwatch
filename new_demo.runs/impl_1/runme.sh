...
HD_PWD='/home/vmware/adc_lab/new_demo/new_demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log new_demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source new_demo.tcl -notrace
