...
HD_PWD='/home/vmware/adc_lab/new_demo/new_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log new_demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source new_demo.tcl
