...
HD_PWD='/home/vmware/adc_lab/lab9_3_1/lab9_3_1.runs/ip_counter_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_counter_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_counter_6.tcl
